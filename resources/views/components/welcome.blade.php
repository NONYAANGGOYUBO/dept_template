...
<div class="bg-gray-200 bg-opacity-25 p-6 lg:p-8">
        <div x-data = "{modal:false}" class="">
            ...
            <button @click ="modal=true" class="rounded-md bg-blue-600 px-4 py-2 text-white hover:bg-blue-950">edit</button>
            <div x-show="modal" class="p-16 bg-gray-100 fixed top-0 left-0 bottom-0 z-10 bg-black/30 flex items-center justify-center w-full">
                <div class="w-full bg-white p-5 rounded-lg" @click.outside = "modal = false">
